...
class EditExercise extends Component{
    ...
    componentDidMount(){
        ...
        .then(res=>{
            this.setState({
                ...
                date:new Date(res.data.date)})}).catch(err=> console.log(err));
    ...
    onSubmit = async data =>{
        ...
        await axios.post('http://localhost:3001/exercises/update/'+this.props.match.params.id, exercise).then(res=>console.log(res.data));
